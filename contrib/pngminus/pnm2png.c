...
static BOOL do_pnm2png (png_struct *png_ptr, png_info *info_ptr,
                 FILE *pnm_file, FILE *alpha_file,
                 BOOL interlace, BOOL alpha);
static int fscan_pnm_magic (FILE *pnm_file, char *magic_buf, size_t magic_buf_size);
static int fscan_pnm_token (FILE *pnm_file, char *token_buf, size_t token_buf_size);
static int fscan_pnm_uint_32 (FILE *pnm_file, png_uint_32 *num_ptr);
static png_uint_32 get_pnm_data (FILE *pnm_file, int depth);
static png_uint_32 get_pnm_value (FILE *pnm_file, int depth);
